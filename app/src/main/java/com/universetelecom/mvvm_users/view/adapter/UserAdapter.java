...
import com.universetelecom.mvvm_users.base.BaseViewHolder;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.UserAdapterViewHolder> {
    ...
    public static class UserAdapterViewHolder extends BaseViewHolder {
        ...
        void bindUser(User user){
            if(mItemUserBinding.getUser() == null){
                mItemUserBinding.setUser(new ItemUserViewModel(user, itemView.getContext()));
            }else {
                mItemUserBinding.getUser().setUser(user);
            }
        }
