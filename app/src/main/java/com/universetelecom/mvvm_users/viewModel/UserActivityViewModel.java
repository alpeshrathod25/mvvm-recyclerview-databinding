...
public class UserActivityViewModel extends Observable {
    ...
    public UserActivityViewModel(@NonNull Context context) {
    ...
    public void updateUserDataList(List<User> peoples) {
